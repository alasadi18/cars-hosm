...
namespace f23store
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Yousef\source\repos\f23store\f23store\App_Data\f23db.mdf;Integrated Security=True");
        int id;
